...
export class UpdateWeightLogDto {
  ...
  @ApiPropertyOptional({ example: 'Sau khi chạy bộ sáng', description: 'Ghi chú thời điểm cân' })
  @IsOptional()
  @IsString()
  note?: string;

  @ApiPropertyOptional({ example: '2026-08-19', description: 'Ngày ghi nhận cân nặng' })
  @IsOptional()
  @IsDateString()
  date?: string;
}

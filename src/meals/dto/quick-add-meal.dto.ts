...
export class QuickAddMealDto {
  @ApiProperty({ example: 'Phở bò ăn ngoài', description: 'Tên hoặc mô tả bữa ăn nhanh' })
  @IsString()
  ...
  @ApiPropertyOptional({ example: 25, description: 'Lượng Protein ước lượng (gram)' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  protein?: number;

  @ApiPropertyOptional({ example: 60, description: 'Lượng Carb ước lượng (gram)' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  carb?: number;

  @ApiPropertyOptional({ example: 15, description: 'Lượng Fat ước lượng (gram)' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  fat?: number;
